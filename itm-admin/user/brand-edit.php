...
<body>
  ...
  if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    $id = $_GET['edit_id'];
    $stmt_edit = $DB_con->prepare('SELECT * FROM partner WHERE pr_id =:uid');
  ...
  if (isset($_POST['btn_save_updates'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('UPDATE partner 
									     SET  pr_name =:ParName,
											  pr_details=:Details,
										     userPic=:upic 
								       WHERE pr_id=:uid');
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <table class="table table-hover table-responsive">
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" type="text" name="ParName" placeholder="Title" value="<?php echo $pr_name; ?>" /></td>
                  </tr>
