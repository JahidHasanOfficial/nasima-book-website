...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    function createSlug($title)
{
    // Remove special characters except Unicode letters, numbers, and space/hyphen
    $slug = preg_replace('/[^\p{L}\p{N}\s-]+/u', '', $title);

    // Replace multiple spaces or hyphens with a single hyphen
    $slug = preg_replace('/[\s-]+/', '-', $slug);

    // Trim hyphens from both ends and convert to lowercase (only for Latin letters)
    $slug = trim($slug, '-');
    ...
    if (!isset($errMSG)) {
      ...
      $stmt = $DB_con->prepare('INSERT INTO blog_section (user_id,category_id,title,slug,details,canonical_link,keyword,description,author,userPic) VALUES(:user_id,:category_id,:Title,:Slug,:Details,:canonical_link, :keyword, :description, :author,:upic)');
            ...
            <div class="card-body">
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <table class="table table-responsive">
                  ...
                  <tr class="d-none">
                    ...
                    <td>
                      <select name="category_id" class="form-select" required> 
                        <?php
                        $cat_query = mysqli_query($con, "SELECT * FROM blog_category WHERE user_id='" . $_SESSION['id'] . "' ORDER BY cat_name");
                        while ($cat_row = mysqli_fetch_array($cat_query)) {
                          echo '<option value="' . $cat_row['b_c_id'] . '">' . $cat_row['cat_name'] . '</option>';
                        }
                        ?>
                      </select>
                    </td>
                  ...
                  <tr>
                    <td><label class="control-label">Blog Title </label></td>
                   ...
                   <tr class="d-none">
                    ...
                    <td>
                      <input type="text" class="form-control" name="canonical_link" placeholder="SEO Canonical Link" value="Na"></input>
                    </td>
                  </tr>
                  ...
                  <tr class="d-none">
                    ...
                    <td>
                      <textarea class="form-control" name="keyword" placeholder="SEO Keyword" id="" cols="30" rows="4" >Remico Agro Industries</textarea>
                    </td>
                  </tr>
                   ...
                   <tr class="d-none">
                    ...
                    <td>
                      <textarea class="form-control" name="description" placeholder="SEO Description" id="" cols="30" rows="4" >Remico Agro Industries</textarea>
                    </td>
                  </tr>
                   ...
                   <tr class="d-none">
                    ...
                    <td>
                      <textarea class="form-control" name="author" placeholder="Author" id="" cols="30" rows="4" required>Remico Agro Industries</textarea>
                    </td>
                  </tr>
