...
<body>
  ...
  if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    $id = $_GET['edit_id'];
    $stmt_edit = $DB_con->prepare('SELECT * FROM about_feature WHERE id =:uid');
  ...
  if (isset($_POST['btn_save_updates'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('UPDATE about_feature  SET  title =:Title, sub_title =:SubTitle, details =:ShortDesc, why_icon =:StatsIcon, userPic=:upic WHERE id=:uid');
  ...
  ?>
        <script>
          ...
          window.location.href = 'about-feature';
        </script>
  <?php
      } else {
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>About Feature Edit / Update</h1>
      <hr>
    </div>
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <table class="table table-responsive">
                  ...
                  <tr>
                    ...
                    <td><textarea name="ShortDesc" class="form-control" cols="30" rows="3" id=""><?php echo $details; ?></textarea></td>
                  </tr>
