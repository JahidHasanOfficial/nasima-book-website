...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('INSERT INTO project_portfolio (user_id, project_id, p_title, userPic) 
															VALUES(:user_id, :ProjectId, :Title, :upic)');
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add New Project Portfolio | <span> <a href="project_portfolio"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <table class="table table-responsive">
                  ...
                  <tr class="">
                    ...
                    <td>
                      <select name="ProjectId" id="" class="form-select" required>
