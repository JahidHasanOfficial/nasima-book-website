...
<body>
  ...
  if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    ...
    $stmt_edit = $DB_con->prepare('SELECT * FROM video WHERE id =:uid');
  ...
  if (isset($_POST['btn_save_updates'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('UPDATE video 
									     SET title =:Title,
											  link =:Link,
										     userPic=:upic 
								       WHERE id=:uid');
            ...
            <div class="card-body">
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <table class="table table-hover table-responsive">
                  ...
                  <tr>
                    <td><label class="control-label">Thambnail Picture </label>
                      <span class="d-block fw-normal text-muted small">
                        Recommended size: 420x320px &nbsp;|&nbsp; <br> Max size: 150KB &nbsp;|&nbsp; <br> Format: PNG (Preferable)
                      </span>
                    </td>
                    <td>
                ...
                <a class="btn btn-danger" href="video"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
