...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('INSERT INTO project (user_id,category_id,title,subtitle,details,userPic) 
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add New Project | <span> <a href="project"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
