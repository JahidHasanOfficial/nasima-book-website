...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add New Partner | <span> <a href="partner"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                <table class="table table-hover table-responsive">
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" type="text" name="ParName" placeholder="Name" value="N/A" /></td>
                  </tr>
