...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
      ...
      $stmt = $DB_con->prepare('INSERT INTO about_feature (user_id,title,sub_title,details,why_icon,userPic) VALUES(:user_id,:Title,:SubTitle,:ShortDesc,:StatsIcon,:upic)');
      ...
      if ($stmt->execute()) {
        echo '<script>alert("Successfully Added ..."); window.location.href = "about-feature";</script>';
        exit();
      } else {
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add New About Feature | <span> <a href="about-feature"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <table class="table table-responsive">
                  ...
                  <tr>
                    ...
                    <td><textarea name="ShortDesc" class="form-control" id="" placeholder="Short Description"></textarea></td>
                  </tr>
