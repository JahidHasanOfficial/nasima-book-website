              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <table class="table table-responsive">
                  ...
                  <tr class="d-none">
                    ...
                    <td>
                      <select name="category_id" id="category-select" class="form-select">
                        ...
                        <?php
                        // You can add category options here if you have a categories table
                        // For now, leaving it as optional
                        ?>
                      </select>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" type="text" name="SubTitle" placeholder="Sub Title" value="<?php echo $SubTitle; ?>" required></td>
                  </tr>

                  <tr class="d-none">
                    <td><label class="control-label"> Description </label></td>
                    <td><textarea name="Details" id="summernote" placeholder="Enter Description" value="no"></textarea></td>
                  </tr>
