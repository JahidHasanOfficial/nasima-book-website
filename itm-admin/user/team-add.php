...
if (isset($_POST['btnsave'])) {
	...
	if (!isset($errMSG)) {
		$stmt = $DB_con->prepare('INSERT INTO team_section (user_id,team_title,team_subtitle,email,userPic) 
															VALUES(:user_id,:TeamTitle,:TeamSubTitle,:Email,:upic)');
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
			...
			<table class="table table-hover table-responsive">
				...
				<tr>
					...
					<td><input class="form-control" type="text" name="TeamSubTitle" placeholder="Designation" value="<?php echo $TeamSubTitle; ?>" /></td>
				</tr>
