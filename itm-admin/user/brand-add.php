...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('INSERT INTO partner (user_id,pr_name,pr_details,userPic) 
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add New Brand | <span> <a href="brand"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                <table class="table table-hover table-responsive">
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" type="text" name="ParName" placeholder="Title" value="<?php echo $ParName; ?>" /></td>
                  </tr>
