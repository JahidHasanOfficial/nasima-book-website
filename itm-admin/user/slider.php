							...
							<table class="table table-hover datatable">
								...
								<tbody id="tbody">
									...
									?>
										<tr>
											<td><?php echo  ++$sl; ?></td>
											<!-- <td><?php echo $eqrow['slider_title']; ?></td> -->
											<td> <img src="user_images/<?php echo $eqrow['userPic']; ?>" class="img-rounded" height="60px;" width="55px;" /></td>
											<td>
												<a class="btn btn-info" href="slider-edit?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" onclick="return confirm('Are You Sure To Edit ?')"><span class="bi bi-pencil-square"></span> </a> 
