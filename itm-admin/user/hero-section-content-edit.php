...
<body>
  ...
  if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    ...
    $stmt_edit = $DB_con->prepare('SELECT * FROM hero_section_content WHERE id =:uid');
  ...
  if (isset($_POST['btn_save_updates'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('UPDATE hero_section_content
									     SET  title =:Title,
											      subtitle=:SubTitle
								           WHERE id=:uid');
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Hero Section Content Edit</h1>
      <hr>
    </div>
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <tr>
                  <td colspan="2"><button type="submit" name="btn_save_updates" class="btn btn-primary">
                    ...
                    <a class="btn btn-danger" href="hero-section-content"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
