...
<body>
  ...
  if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    $id = $_GET['edit_id'];
    $stmt_edit = $DB_con->prepare('SELECT * FROM project WHERE id =:uid');
  ...
  if (isset($_POST['btn_save_updates'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('UPDATE project SET category_id =:category_id, title =:Title, subtitle=:SubTitle, details=:Details, userPic=:upic WHERE id=:uid');
				...
				<tr class="d-none">
                    ...
                    <td>
                      <select name="category_id" class="form-select">
                        ...
                        <?php
                        $ct = mysqli_query($con, "SELECT * FROM project_category WHERE user_id='" . $_SESSION['id'] . "'");
