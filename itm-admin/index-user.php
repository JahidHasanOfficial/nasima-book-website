...
if (isset($_SESSION['id'])) {
  $ses = mysqli_query($conn, "SELECT * FROM user_profile WHERE userid='" . $_SESSION['id'] . "'");
  $sesrow = mysqli_fetch_array($ses);

  if ($sesrow['access'] == 1 || $sesrow['access'] == 2) {
    // login successful → user dashboard এ পাঠানো হবে
    header('Location: itm-admin/user-dashboard/index.php');
    exit;
  } else {
...
<body>
  ...
  <section class="w3l-mockup-form">
      ...
      <div class="workinghny-form-grid">
        <div class="main-mockup">
          ...
          <div class="w3l_form align-self">
            <img src="includes/web.jpg" width="100%">
          </div>
          <div class="content-wthree text-center"> <br> <br> <br>
            <div style="margin-top:20px;margin-bottom:20px;">
              <img src="includes/lse-logo.png" width="250px" />
              <br>             
              <p>A Smart Website CMS</p>
            </div>

            <form action="login-user.php" method="post">
              <input type="text" class="text" name="email" placeholder="Enter Your User Name" required="">
    ...
    <div class="copyright text-center">
      <p class="copy-footer-29">From ©2018 | Powered By <a href="https://itmsofts.com">ITM-SOFTS</a></p>
    </div>
